...
{	 
	...
	GPIO_PinAFConfig(GPIOA,GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3,GPIO_AF_TIM5);
...
void TIM3_Cap_Init(u16 arr, u16 psc)
{
	...
	GPIO_PinAFConfig(GPIOA,GPIO_Pin_6|GPIO_Pin_7,GPIO_AF_TIM3);
	GPIO_PinAFConfig(GPIOB,GPIO_Pin_0|GPIO_Pin_1,GPIO_AF_TIM3);
